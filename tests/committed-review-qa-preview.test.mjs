...
function authoritativeSnapshot(chain) {
  return {
    ...
    generationJob: { id: "job-a", tenantId: "tenant-a", frameModelId: chain.entry.model.id, currentHeadEventSha256: H.head, currentHeadEventType: "output-recorded", currentOutputManifestSha256: hash(chain.manifestBytes), currentOutputModelSha256: hash(chain.glb), currentOutputManifestByteLength: chain.manifestBytes.length, currentOutputModelByteLength: chain.glb.length, sourceSetSha256: H.sourceSet, sourceAssetSha256s: [H.source], measurementSetSha256: H.measurement },
